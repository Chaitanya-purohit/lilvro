  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3 sm:px-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <Link href="/" className="group flex items-center gap-2">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--accent)] text-sm font-bold text-white shadow-sm transition group-hover:bg-[var(--accent-hover)]">
                lv
              </span>
              <span className="display text-xl tracking-tight">lilvro</span>
      ...
      <footer className="mx-auto max-w-6xl px-4 pb-10 text-sm text-[var(--muted)] sm:px-6">
        Study sessions stay on your family’s account. No kid-facing screen during tutoring.
      </footer>
    </div>
  );
}
